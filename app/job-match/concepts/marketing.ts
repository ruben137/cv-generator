...
export const marketingConcepts = [
  ...
  concept({ id: "google-ads", category: "tool", es: "Google Ads", en: "Google Ads", families: [...family], esAliases: ["Google AdWords", "AdWords"], enAliases: ["Google AdWords", "AdWords"], relations: [["paid-media", "uses-tool", 0.85]] }),
